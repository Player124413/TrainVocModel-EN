...
from infer.lib.infer_pack import refinegan_for_refineganvctkv2_and_etc
from infer.lib.infer_pack.refinegan_for_refineganvctkv2_and_etc import RefineGANGenerator
