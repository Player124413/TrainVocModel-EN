...
from infer.lib.infer_pack import refinegan_for_refineganvctkv2_and_e.t.c
from infer.lib.infer_pack.refinegan_for_refineganvctkv2_and_e.t.c import RefineGANGenerator
